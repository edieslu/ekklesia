...
class Provincia(models.Model):
	nombre=models.CharField(max_length=50,help_text='Ingrese el nombre de una Provincia Ej: Loja,'
		+' El Oro')
...
class Canton(models.Model):
	nombre=models.CharField(max_length=50,help_text='Ingrese un Canton Ej: Espíndola, Calvas')
...
class Parroquia(models.Model):
	nombre=models.CharField(max_length=50,help_text='Ingrese Parroquia Ej: Catamayo, Cariamanga')
